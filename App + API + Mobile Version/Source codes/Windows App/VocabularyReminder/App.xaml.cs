...
namespace VocabularyReminder
{
    ...
    public partial class App : Application
    {
        ...
        //public static string API_URL = "http://192.168.1.93:5000";
        public static string API_URL = "https://vocabularyreminderapi.azurewebsites.net";
        public static LoginResponseDto User = null;

        protected override void OnStartup(StartupEventArgs e)
        {
            DataAccess.InitializeDatabase();
            // Register AUMID, COM server, and activator
            DesktopNotificationManagerCompat.RegisterAumidAndComServer<MyNotificationActivator>("PVD.VocabularyReminder");
